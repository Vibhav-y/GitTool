            ...
            <div style={{
                ...
                <div className="footer-grid">
                        ...
                        <div style={{ display: 'flex', gap: '12px' }}>
                            {[
                                ...
                                <a key={i} href={href} target="_blank" rel="noreferrer" style={{
                                    ...
                                    onMouseLeave={(e: any) => e.currentTarget.style.color = 'var(--text-tertiary)'}
                                >
                                    <Icon size={17} />
                                </a>
                            ))}
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                            {['React + Vite', 'Node.js + Express', 'OpenAI GPT', 'Supabase Auth & DB', 'GitHub OAuth API', 'Razorpay Payments'].map((t: any) => (
                                <span key={t} style={{
                ...
                <div style={{
                    ...
                    <span style={{ color: 'var(--text-tertiary)', fontSize: '0.75rem', fontFamily: 'var(--font-mono)' }}>
                        (c) {year} GitTool. All rights reserved.
                    </span>
