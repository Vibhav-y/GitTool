...
const FAQS = [
    ...
    { question: "What AI models power the automation tools?", answer: "GitTalk utilizes state-of-the-art AI models specifically fine-tuned on astoundingly large codebases to provide hyper-contextual code reviews, commit messages, and PR summaries." },
